...
abstract class EntityCountryQuickRepoAbstract(
    ...
    override fun removeOneIdFromSet(countryName: String, entityId: Long) {
        ...
        if (result.error != null) throw DeleteException("EntityCountryQuickRepo country $countryName", entityType, entityId.toString())
    }
...
@Repository
class EventCountryQuickRepoImpl : EntityCountryQuickRepoAbstract(EntityType.EVENT.nameString)
