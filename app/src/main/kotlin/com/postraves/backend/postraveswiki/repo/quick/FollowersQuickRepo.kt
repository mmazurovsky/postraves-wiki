...
@Repository
class EventWeeklyFollowersQuickRepoImpl : WeeklyFollowersQuickRepo(EntityType.EVENT.nameString)
...
@Repository
class EventOverallFollowersQuickRepoImpl: OverallFollowersQuickRepo(EntityType.EVENT.nameString)
