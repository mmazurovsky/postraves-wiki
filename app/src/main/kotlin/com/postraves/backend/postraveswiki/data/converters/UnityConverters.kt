...
class UnityConvertersImpl(
    ...
    override fun createFullDtoFromRecord(unityRecord: UnityRecord, countryRecord: CountryRecord, isFollowed: Boolean) : UnityFullDto {
        return UnityFullDto(
            ...
            instagramUsername = unityRecord.unityInstagramUsername,
            soundcloudUsername = unityRecord.unitySoundcloudUsername,
            bandcampUsername = unityRecord.unityBandcampUsername,
